 ...
 */
package mod.gottsch.forge.magic_things.core.rarity;
 ...
 *
 */
public enum MagicThingsRarity implements IRarity {
	...
	static {
		for (MagicThingsRarity type : EnumSet.allOf(MagicThingsRarity.class)) {
	 ...
	 * @param value
	 */
	MagicThingsRarity(int code, String value) {
		this.code = code;
		this.value = value;
	}
	 ...
	 * @return
	 */
	public static MagicThingsRarity getByCode(Integer code) {
		return (MagicThingsRarity) codes.get(code);
	}
	/**
	 * 
	 * @param value
	 * @return
	 */
	public static MagicThingsRarity getByValue(String value) {
		return (MagicThingsRarity) values.get(value);
	}
	...
	public static List<String> getNames() {
		List<String> names = EnumSet.allOf(MagicThingsRarity.class).stream().map(x -> x.name()).collect(Collectors.toList());
		return names;
	}
}